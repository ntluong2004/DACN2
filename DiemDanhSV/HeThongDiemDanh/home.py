...
class Face_Recognition_System:
    def __init__(self, root):
        ...
        img2 = img2.resize((550, 130), PIL.Image.LANCZOS)
        ...
        title_lbl = Label(bg_img, text="Phần mềm điểm danh bằng nhận diện khuôn mặt", font=(
        ...
        b1_1 = Button(bg_img, text="Thông tin sinh viên", cursor="hand2", command=self.student_details, font=(
