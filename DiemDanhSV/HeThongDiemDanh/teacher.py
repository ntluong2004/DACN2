    ...
    def add_data(self):
        if self.var_securityQ.get() == "Select" or self.var_id.get() == "" or self.var_name.get() == "":
            ...
            try:
                ...
                conn.close()
                messagebox.showinfo(
                    "Thành công", "Thêm thông tin giảng viên thành công", parent=self.root)
            ...
            try:
                ...
                if Update > 0:
                    ...
                    if not Update:
                        return
                messagebox.showinfo(
                    "Thành công", "Cập nhật thông tin điểm danh thành công", parent=self.root)
                conn.commit()
                self.fetch_data()
                self.reset_data()
                conn.close()
    ...
    def search_data(self):
        if self.var_com_search.get() == "" or self.var_search.get() == "":
            ...
            try:
                ...
                my_cursor.execute("select * from teacher where "+str(
